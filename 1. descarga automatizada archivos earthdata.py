...
for url in open('E:\proyecto_incendios_forestales\scripts\liens eartdata vers images MOD09A1 et MYD09A1\MOD09A1_links_earthdata2.txt'):
##takes out the \n in the list of urls     
    url=url.rstrip('\n')
    print url
    print "waiting..."
##checks if the file has already been downloaded or not    
    if os.path.exists ("E:/proyecto_incendios_forestales/datos_MODIS/MOD09A1/"+ url[-45:]):
